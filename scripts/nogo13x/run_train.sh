...
do
    ...
    ./engine/katago selfplay -models-dir  data/models -config selfplay.cfg -output-dir data/selfplay  -max-games-total 15000
    cd train
    ...
    bash train.sh ../data ../data/shuffleddata/current b28c512n b28c512nbt-fson-mish-rvglr-bnh 256 main -multi-gpus 0,1,2,3 -lr-scale 1.0
