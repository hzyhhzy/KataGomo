baseDir="../data/train/"
lossItems={"p0loss":(1.40,1.8),"vloss":(0.4,0.6),"loss":(44.7,45.2),"gnorm_batch":(0,2e3),"exgnorm":(0,3e2),"norm_normal_batch":(0,0)} #name,ylim,  0 means default
trainDirs=["b10c256n","b10c128","b10c128muon"];
lossTypes=["train"]
outputFile="../loss.png"
