...
def main(rank: int, world_size: int, args, multi_gpu_device_ids, readpipes, writepipes, barrier):
    ...
    def pslr_func(batchsize,lrscale):
        pslr = 3e-5 * lrscale * (batchsize/1.0)**padamw_p
        return pslr
    ...
    def load():
        ...
        if path_to_load_from is None:
            ...
            optimizer = PadamW(get_param_groups(raw_model,train_state,running_metrics), lr=0.001, eps=1e-6)
