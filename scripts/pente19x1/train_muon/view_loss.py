baseDir="../data/train/"
lossItems={"Ip0loss":(1.6,1.9),"Ivloss":(0.6,0.8),"loss":(44,46),"Ipacc1":(0.5,0.6),"gnorm_batch":(0,0),"exgnorm":(0,500),"norm_normal_batch":(0,0),"norm_output_batch":(0,0),"pslr_batch":(1e-7,1e-2)}#name,ylim,  0 means default
...
trainDirs=["b6c64d2","b6c64padam2_fd4","b6c64muon_ki3_fd3","b6c64muon_ki3","b6c64muon_ki4","b6c64muon_ki7","b6c64adam6"]
trainDirs=["b18c384n","b18c384n3"]
