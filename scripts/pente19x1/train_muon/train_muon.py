...
from muon_kissin import MuonWithAuxAdamKissin,MuonWithAuxAdamKimi
padamw_p=0.5
...
def main(rank: int, world_size: int, args, multi_gpu_device_ids, readpipes, writepipes, barrier):
    ...
    def load():
        ...
        if path_to_load_from is None:
            ...
            optimizer = MuonWithAuxAdamKissin(get_param_groups(raw_model,train_state,running_metrics))
