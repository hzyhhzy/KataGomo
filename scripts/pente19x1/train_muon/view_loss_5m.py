baseDir="../data/train/"
lossItems={"Ip0loss":(1.7,2),"Ivloss":(0.22,0.26),"loss":(43,45),"Ipacc1":(0.56,0.65),"gnorm_batch":(0,10000),"exgnorm":(0,500),"norm_normal_batch":(0,5e4),"pslr_batch":(1e-7,1e-2)}#name,ylim,  0 means default
#trainDirs=["b12c240nb1t_adam2_lr2","b6c64d1","b6c64sgd3b"]
trainDirs=["b12c240nb1t4","b12c240nb1t_muon1"]
