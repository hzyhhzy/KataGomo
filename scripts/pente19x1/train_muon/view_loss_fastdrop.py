...
lossItems={"Ip0loss":(0,0),"Ivloss":(0,0),"loss":(0,0),"Ipacc1":(0,0),"gnorm_batch":(0,0),"exgnorm":(0,0),"norm_normal_batch":(0,0)}#name,ylim,  0 means default
...
trainDirs=["b6c64sgd6_fdscaletest"]
