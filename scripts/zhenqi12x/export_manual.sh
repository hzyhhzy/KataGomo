...
cd train
CUDA_VISIBLE_DEVICES="0" python save_model_for_export_manual.py -traindir ../data/train/b10c384n -exportdir ../data/torchmodels_toexport -exportprefix b10c384n
...
CUDA_VISIBLE_DEVICES="0" bash export.sh zhenqi12x ../data 0