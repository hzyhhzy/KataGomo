        ...
        for y in range(2, 11):
            ...
            if t_value:
                ...
                # 保存结果到文件
                    ...
                    with open("results_bt10x10.txt", "a") as f:
...
if __name__ == "__main__":
    # 示例引擎启动命令（需要替换为实际命令）
    engine_command = "D:/katago/engine2025/breakthrough_15x.exe gtp -config ./engine2024.cfg -model D:/kata2025/breakthrough10x/data/latest.bin.gz"
