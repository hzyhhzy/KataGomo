...
const ArchitectureSignature& int8QualifiedArchitectureSignature() {
  // Generated by the weight-independent 24L/C256/H8/D32/F768 production
  // fixture and asserted there as a canonical-encoding compatibility lock.
  static const ArchitectureSignature signature{
    CANONICAL_ARCHITECTURE_SCHEMA_VERSION,
    std::array<uint8_t,32>{
      0xb1,0xe8,0x58,0xd6,0xd8,0xd5,0xfa,0xa4,
      0x93,0xbf,0xdc,0xe7,0xf5,0x93,0xfa,0xda,
      0xcb,0x30,0x79,0x6e,0x85,0xa1,0xd4,0x52,
      0xeb,0xc9,0xbc,0xc4,0x1d,0xd4,0x83,0xdc,
    }
  };
  return signature;
}
