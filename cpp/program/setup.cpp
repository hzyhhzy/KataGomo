...
vector<SearchParams> Setup::loadParams(
  ...
  for(int i = 0; i<numBots; i++) {
    ...
    if(cfg.contains("multiHeadNormalPolicyHead1Mix"+idxStr)) params.multiHeadNormalPolicyHead1Mix = cfg.getDouble("multiHeadNormalPolicyHead1Mix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadNormalPolicyHead1Mix"))   params.multiHeadNormalPolicyHead1Mix = cfg.getDouble("multiHeadNormalPolicyHead1Mix",        0.0, 1.0);
    else                                                      params.multiHeadNormalPolicyHead1Mix = 0.0;
    if(cfg.contains("multiHeadObjectiveSearchStrength"+idxStr)) params.multiHeadObjectiveSearchStrength = cfg.getDouble("multiHeadObjectiveSearchStrength"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadObjectiveSearchStrength"))   params.multiHeadObjectiveSearchStrength = cfg.getDouble("multiHeadObjectiveSearchStrength",        0.0, 1.0);
    else                                                         params.multiHeadObjectiveSearchStrength = 0.0;
    if(cfg.contains("multiHeadObjectiveSelectionPower"+idxStr)) params.multiHeadObjectiveSelectionPower = cfg.getDouble("multiHeadObjectiveSelectionPower"+idxStr, 0.1, 10.0);
    else if(cfg.contains("multiHeadObjectiveSelectionPower"))   params.multiHeadObjectiveSelectionPower = cfg.getDouble("multiHeadObjectiveSelectionPower",        0.1, 10.0);
    else                                                         params.multiHeadObjectiveSelectionPower = 2.0;
    if(cfg.contains("multiHeadObjectiveSelectionSharpness"+idxStr)) params.multiHeadObjectiveSelectionSharpness = cfg.getDouble("multiHeadObjectiveSelectionSharpness"+idxStr, 0.0, 16.0);
    else if(cfg.contains("multiHeadObjectiveSelectionSharpness"))   params.multiHeadObjectiveSelectionSharpness = cfg.getDouble("multiHeadObjectiveSelectionSharpness",        0.0, 16.0);
    else                                                             params.multiHeadObjectiveSelectionSharpness = 0.0;
    if(cfg.contains("multiHeadObjectivePolicyMix"+idxStr)) params.multiHeadObjectivePolicyMix = cfg.getDouble("multiHeadObjectivePolicyMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadObjectivePolicyMix"))   params.multiHeadObjectivePolicyMix = cfg.getDouble("multiHeadObjectivePolicyMix",        0.0, 1.0);
    else                                                    params.multiHeadObjectivePolicyMix = 0.0;
    if(cfg.contains("multiHeadObjectiveSeparatePlayouts"+idxStr)) params.multiHeadObjectiveSeparatePlayouts = cfg.getBool("multiHeadObjectiveSeparatePlayouts"+idxStr);
    else if(cfg.contains("multiHeadObjectiveSeparatePlayouts"))   params.multiHeadObjectiveSeparatePlayouts = cfg.getBool("multiHeadObjectiveSeparatePlayouts");
    else                                                           params.multiHeadObjectiveSeparatePlayouts = false;
    if(cfg.contains("multiHeadObjectiveCrossWeight"+idxStr)) params.multiHeadObjectiveCrossWeight = cfg.getDouble("multiHeadObjectiveCrossWeight"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadObjectiveCrossWeight"))   params.multiHeadObjectiveCrossWeight = cfg.getDouble("multiHeadObjectiveCrossWeight",        0.0, 1.0);
    else                                                       params.multiHeadObjectiveCrossWeight = 0.0;
    if(cfg.contains("multiHeadObjectiveValueWeightExponent"+idxStr)) params.multiHeadObjectiveValueWeightExponent = cfg.getDouble("multiHeadObjectiveValueWeightExponent"+idxStr, 0.0, 4.0);
    else if(cfg.contains("multiHeadObjectiveValueWeightExponent"))   params.multiHeadObjectiveValueWeightExponent = cfg.getDouble("multiHeadObjectiveValueWeightExponent",        0.0, 4.0);
    else                                                              params.multiHeadObjectiveValueWeightExponent = 1.0;
    if(cfg.contains("multiHeadObjectiveVctWeight"+idxStr)) params.multiHeadObjectiveVctWeight = cfg.getDouble("multiHeadObjectiveVctWeight"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadObjectiveVctWeight"))   params.multiHeadObjectiveVctWeight = cfg.getDouble("multiHeadObjectiveVctWeight",        0.0, 10.0);
    else                                                    params.multiHeadObjectiveVctWeight = 1.0;
    if(cfg.contains("multiHeadVctObjectiveBudgetMix"+idxStr)) params.multiHeadVctObjectiveBudgetMix = cfg.getDouble("multiHeadVctObjectiveBudgetMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctObjectiveBudgetMix"))   params.multiHeadVctObjectiveBudgetMix = cfg.getDouble("multiHeadVctObjectiveBudgetMix",        0.0, 1.0);
    else                                                       params.multiHeadVctObjectiveBudgetMix = 1.0;
    if(cfg.contains("multiHeadVctMaxAttackProp"+idxStr)) params.multiHeadVctMaxAttackProp = cfg.getDouble("multiHeadVctMaxAttackProp"+idxStr, 0.0, 0.9);
    else if(cfg.contains("multiHeadVctMaxAttackProp"))   params.multiHeadVctMaxAttackProp = cfg.getDouble("multiHeadVctMaxAttackProp",        0.0, 0.9);
    else                                                  params.multiHeadVctMaxAttackProp = 0.0;
    if(cfg.contains("multiHeadVctMaxDefenseProp"+idxStr)) params.multiHeadVctMaxDefenseProp = cfg.getDouble("multiHeadVctMaxDefenseProp"+idxStr, 0.0, 0.9);
    else if(cfg.contains("multiHeadVctMaxDefenseProp"))   params.multiHeadVctMaxDefenseProp = cfg.getDouble("multiHeadVctMaxDefenseProp",        0.0, 0.9);
    else                                                   params.multiHeadVctMaxDefenseProp = 0.0;
    if(cfg.contains("multiHeadVctUcbCoeff"+idxStr)) params.multiHeadVctUcbCoeff = cfg.getDouble("multiHeadVctUcbCoeff"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctUcbCoeff"))   params.multiHeadVctUcbCoeff = cfg.getDouble("multiHeadVctUcbCoeff",        0.0, 10.0);
    else                                            params.multiHeadVctUcbCoeff = 1.0;
    if(cfg.contains("multiHeadVctProbScale"+idxStr)) params.multiHeadVctProbScale = cfg.getDouble("multiHeadVctProbScale"+idxStr, 0.001, 1.0);
    else if(cfg.contains("multiHeadVctProbScale"))   params.multiHeadVctProbScale = cfg.getDouble("multiHeadVctProbScale",        0.001, 1.0);
    else                                             params.multiHeadVctProbScale = 0.20;
    if(cfg.contains("multiHeadVctProbPower"+idxStr)) params.multiHeadVctProbPower = cfg.getDouble("multiHeadVctProbPower"+idxStr, 0.1, 10.0);
    else if(cfg.contains("multiHeadVctProbPower"))   params.multiHeadVctProbPower = cfg.getDouble("multiHeadVctProbPower",        0.1, 10.0);
    else                                             params.multiHeadVctProbPower = 1.0;
    if(cfg.contains("multiHeadVctMainWinSuppression"+idxStr)) params.multiHeadVctMainWinSuppression = cfg.getDouble("multiHeadVctMainWinSuppression"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctMainWinSuppression"))   params.multiHeadVctMainWinSuppression = cfg.getDouble("multiHeadVctMainWinSuppression",        0.0, 10.0);
    else                                                        params.multiHeadVctMainWinSuppression = 0.0;
    if(cfg.contains("multiHeadVctPolicyMix"+idxStr)) params.multiHeadVctPolicyMix = cfg.getDouble("multiHeadVctPolicyMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctPolicyMix"))   params.multiHeadVctPolicyMix = cfg.getDouble("multiHeadVctPolicyMix",        0.0, 1.0);
    else                                             params.multiHeadVctPolicyMix = 1.0;
    if(cfg.contains("multiHeadVctPolicyConsensusMix"+idxStr)) params.multiHeadVctPolicyConsensusMix = cfg.getDouble("multiHeadVctPolicyConsensusMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctPolicyConsensusMix"))   params.multiHeadVctPolicyConsensusMix = cfg.getDouble("multiHeadVctPolicyConsensusMix",        0.0, 1.0);
    else                                                       params.multiHeadVctPolicyConsensusMix = 0.0;
    if(cfg.contains("multiHeadVctUseNormalRules"+idxStr)) params.multiHeadVctUseNormalRules = cfg.getBool("multiHeadVctUseNormalRules"+idxStr);
    else if(cfg.contains("multiHeadVctUseNormalRules"))   params.multiHeadVctUseNormalRules = cfg.getBool("multiHeadVctUseNormalRules");
    else                                                   params.multiHeadVctUseNormalRules = false;
    if(cfg.contains("multiHeadVctProbeStartFraction"+idxStr)) params.multiHeadVctProbeStartFraction = cfg.getDouble("multiHeadVctProbeStartFraction"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctProbeStartFraction"))   params.multiHeadVctProbeStartFraction = cfg.getDouble("multiHeadVctProbeStartFraction",        0.0, 1.0);
    else                                                       params.multiHeadVctProbeStartFraction = 0.0;
    if(cfg.contains("multiHeadVctProbeEndFraction"+idxStr)) params.multiHeadVctProbeEndFraction = cfg.getDouble("multiHeadVctProbeEndFraction"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctProbeEndFraction"))   params.multiHeadVctProbeEndFraction = cfg.getDouble("multiHeadVctProbeEndFraction",        0.0, 1.0);
    else                                                     params.multiHeadVctProbeEndFraction = 1.0;
    if(cfg.contains("multiHeadVctProbeRampFraction"+idxStr)) params.multiHeadVctProbeRampFraction = cfg.getDouble("multiHeadVctProbeRampFraction"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctProbeRampFraction"))   params.multiHeadVctProbeRampFraction = cfg.getDouble("multiHeadVctProbeRampFraction",        0.0, 1.0);
    else                                                      params.multiHeadVctProbeRampFraction = 0.0;
    if(cfg.contains("multiHeadVctPriorVisits"+idxStr)) params.multiHeadVctPriorVisits = cfg.getDouble("multiHeadVctPriorVisits"+idxStr, 0.0, 1000.0);
    else if(cfg.contains("multiHeadVctPriorVisits"))   params.multiHeadVctPriorVisits = cfg.getDouble("multiHeadVctPriorVisits",        0.0, 1000.0);
    else                                               params.multiHeadVctPriorVisits = 4.0;
    if(cfg.contains("multiHeadVctNormalPolicyMaxMix"+idxStr)) params.multiHeadVctNormalPolicyMaxMix = cfg.getDouble("multiHeadVctNormalPolicyMaxMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctNormalPolicyMaxMix"))   params.multiHeadVctNormalPolicyMaxMix = cfg.getDouble("multiHeadVctNormalPolicyMaxMix",        0.0, 1.0);
    else                                                       params.multiHeadVctNormalPolicyMaxMix = 0.0;
    if(cfg.contains("multiHeadVctAttackPolicyScale"+idxStr)) params.multiHeadVctAttackPolicyScale = cfg.getDouble("multiHeadVctAttackPolicyScale"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctAttackPolicyScale"))   params.multiHeadVctAttackPolicyScale = cfg.getDouble("multiHeadVctAttackPolicyScale",        0.0, 1.0);
    else                                                      params.multiHeadVctAttackPolicyScale = 1.0;
    if(cfg.contains("multiHeadVctDefensePolicyScale"+idxStr)) params.multiHeadVctDefensePolicyScale = cfg.getDouble("multiHeadVctDefensePolicyScale"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctDefensePolicyScale"))   params.multiHeadVctDefensePolicyScale = cfg.getDouble("multiHeadVctDefensePolicyScale",        0.0, 1.0);
    else                                                       params.multiHeadVctDefensePolicyScale = 1.0;
    if(cfg.contains("multiHeadVctPolicyRawProbMix"+idxStr)) params.multiHeadVctPolicyRawProbMix = cfg.getDouble("multiHeadVctPolicyRawProbMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctPolicyRawProbMix"))   params.multiHeadVctPolicyRawProbMix = cfg.getDouble("multiHeadVctPolicyRawProbMix",        0.0, 1.0);
    else                                                      params.multiHeadVctPolicyRawProbMix = 0.0;
    if(cfg.contains("multiHeadVctNormalPolicyPow"+idxStr)) params.multiHeadVctNormalPolicyPow = cfg.getDouble("multiHeadVctNormalPolicyPow"+idxStr, 0.1, 10.0);
    else if(cfg.contains("multiHeadVctNormalPolicyPow"))   params.multiHeadVctNormalPolicyPow = cfg.getDouble("multiHeadVctNormalPolicyPow",        0.1, 10.0);
    else                                                   params.multiHeadVctNormalPolicyPow = 2.0;
    if(cfg.contains("multiHeadDrawWinNormalPolicyMaxMix"+idxStr)) params.multiHeadDrawWinNormalPolicyMaxMix = cfg.getDouble("multiHeadDrawWinNormalPolicyMaxMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadDrawWinNormalPolicyMaxMix"))   params.multiHeadDrawWinNormalPolicyMaxMix = cfg.getDouble("multiHeadDrawWinNormalPolicyMaxMix",        0.0, 1.0);
    else                                                           params.multiHeadDrawWinNormalPolicyMaxMix = 0.0;
    if(cfg.contains("multiHeadDrawLossNormalPolicyMaxMix"+idxStr)) params.multiHeadDrawLossNormalPolicyMaxMix = cfg.getDouble("multiHeadDrawLossNormalPolicyMaxMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadDrawLossNormalPolicyMaxMix"))   params.multiHeadDrawLossNormalPolicyMaxMix = cfg.getDouble("multiHeadDrawLossNormalPolicyMaxMix",        0.0, 1.0);
    else                                                            params.multiHeadDrawLossNormalPolicyMaxMix = 0.0;
    if(cfg.contains("multiHeadDrawNormalPolicyProbScale"+idxStr)) params.multiHeadDrawNormalPolicyProbScale = cfg.getDouble("multiHeadDrawNormalPolicyProbScale"+idxStr, 0.001, 1.0);
    else if(cfg.contains("multiHeadDrawNormalPolicyProbScale"))   params.multiHeadDrawNormalPolicyProbScale = cfg.getDouble("multiHeadDrawNormalPolicyProbScale",        0.001, 1.0);
    else                                                           params.multiHeadDrawNormalPolicyProbScale = 0.20;
    if(cfg.contains("multiHeadDrawPolicyRawProbMix"+idxStr)) params.multiHeadDrawPolicyRawProbMix = cfg.getDouble("multiHeadDrawPolicyRawProbMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadDrawPolicyRawProbMix"))   params.multiHeadDrawPolicyRawProbMix = cfg.getDouble("multiHeadDrawPolicyRawProbMix",        0.0, 1.0);
    else                                                       params.multiHeadDrawPolicyRawProbMix = 0.0;
    if(cfg.contains("multiHeadDrawNormalPolicyPow"+idxStr)) params.multiHeadDrawNormalPolicyPow = cfg.getDouble("multiHeadDrawNormalPolicyPow"+idxStr, 0.1, 10.0);
    else if(cfg.contains("multiHeadDrawNormalPolicyPow"))   params.multiHeadDrawNormalPolicyPow = cfg.getDouble("multiHeadDrawNormalPolicyPow",        0.1, 10.0);
    else                                                     params.multiHeadDrawNormalPolicyPow = 1.0;
    if(cfg.contains("multiHeadDrawPolicyFlattening"+idxStr)) params.multiHeadDrawPolicyFlattening = cfg.getDouble("multiHeadDrawPolicyFlattening"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadDrawPolicyFlattening"))   params.multiHeadDrawPolicyFlattening = cfg.getDouble("multiHeadDrawPolicyFlattening",        0.0, 1.0);
    else                                                       params.multiHeadDrawPolicyFlattening = 0.0;
    if(cfg.contains("multiHeadDrawRootMinVisitsCoeff"+idxStr)) params.multiHeadDrawRootMinVisitsCoeff = cfg.getDouble("multiHeadDrawRootMinVisitsCoeff"+idxStr, 0.0, 100.0);
    else if(cfg.contains("multiHeadDrawRootMinVisitsCoeff"))   params.multiHeadDrawRootMinVisitsCoeff = cfg.getDouble("multiHeadDrawRootMinVisitsCoeff",        0.0, 100.0);
    else                                                         params.multiHeadDrawRootMinVisitsCoeff = 0.0;
    if(cfg.contains("multiHeadDrawAuxRootVisits"+idxStr)) params.multiHeadDrawAuxRootVisits = cfg.getDouble("multiHeadDrawAuxRootVisits"+idxStr, 0.0, 64.0);
    else if(cfg.contains("multiHeadDrawAuxRootVisits"))   params.multiHeadDrawAuxRootVisits = cfg.getDouble("multiHeadDrawAuxRootVisits",        0.0, 64.0);
    else                                                    params.multiHeadDrawAuxRootVisits = 0.0;
    if(cfg.contains("multiHeadTacticalRootVisits"+idxStr)) params.multiHeadTacticalRootVisits = cfg.getDouble("multiHeadTacticalRootVisits"+idxStr, 0.0, 64.0);
    else if(cfg.contains("multiHeadTacticalRootVisits"))   params.multiHeadTacticalRootVisits = cfg.getDouble("multiHeadTacticalRootVisits",        0.0, 64.0);
    else                                                     params.multiHeadTacticalRootVisits = 0.0;
    if(cfg.contains("multiHeadTacticalContrastiveMix"+idxStr)) params.multiHeadTacticalContrastiveMix = cfg.getDouble("multiHeadTacticalContrastiveMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadTacticalContrastiveMix"))   params.multiHeadTacticalContrastiveMix = cfg.getDouble("multiHeadTacticalContrastiveMix",        0.0, 1.0);
    else                                                        params.multiHeadTacticalContrastiveMix = 0.0;
    if(cfg.contains("multiHeadTacticalObjectiveMask"+idxStr)) params.multiHeadTacticalObjectiveMask = cfg.getInt("multiHeadTacticalObjectiveMask"+idxStr, 0, 15);
    else if(cfg.contains("multiHeadTacticalObjectiveMask"))   params.multiHeadTacticalObjectiveMask = cfg.getInt("multiHeadTacticalObjectiveMask",        0, 15);
    else                                                       params.multiHeadTacticalObjectiveMask = 15;
    if(cfg.contains("multiHeadTacticalDisproofStrength"+idxStr)) params.multiHeadTacticalDisproofStrength = cfg.getDouble("multiHeadTacticalDisproofStrength"+idxStr, 0.0, 64.0);
    else if(cfg.contains("multiHeadTacticalDisproofStrength"))   params.multiHeadTacticalDisproofStrength = cfg.getDouble("multiHeadTacticalDisproofStrength",        0.0, 64.0);
    else                                                          params.multiHeadTacticalDisproofStrength = 0.0;
    if(cfg.contains("multiHeadTacticalPolicyPower"+idxStr)) params.multiHeadTacticalPolicyPower = cfg.getDouble("multiHeadTacticalPolicyPower"+idxStr, 0.25, 8.0);
    else if(cfg.contains("multiHeadTacticalPolicyPower"))   params.multiHeadTacticalPolicyPower = cfg.getDouble("multiHeadTacticalPolicyPower",        0.25, 8.0);
    else                                                       params.multiHeadTacticalPolicyPower = 1.0;
    if(cfg.contains("multiHeadDrawForcedReplyRootVisits"+idxStr)) params.multiHeadDrawForcedReplyRootVisits = cfg.getDouble("multiHeadDrawForcedReplyRootVisits"+idxStr, 0.0, 64.0);
    else if(cfg.contains("multiHeadDrawForcedReplyRootVisits"))   params.multiHeadDrawForcedReplyRootVisits = cfg.getDouble("multiHeadDrawForcedReplyRootVisits",        0.0, 64.0);
    else                                                            params.multiHeadDrawForcedReplyRootVisits = 0.0;
    if(cfg.contains("multiHeadDrawForcedReplyTreeVisits"+idxStr)) params.multiHeadDrawForcedReplyTreeVisits = cfg.getDouble("multiHeadDrawForcedReplyTreeVisits"+idxStr, 0.0, 64.0);
    else if(cfg.contains("multiHeadDrawForcedReplyTreeVisits"))   params.multiHeadDrawForcedReplyTreeVisits = cfg.getDouble("multiHeadDrawForcedReplyTreeVisits",        0.0, 64.0);
    else                                                            params.multiHeadDrawForcedReplyTreeVisits = 0.0;
    if(cfg.contains("multiHeadDrawForcedReplyAuxPolicyGate"+idxStr)) params.multiHeadDrawForcedReplyAuxPolicyGate = cfg.getDouble("multiHeadDrawForcedReplyAuxPolicyGate"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadDrawForcedReplyAuxPolicyGate"))   params.multiHeadDrawForcedReplyAuxPolicyGate = cfg.getDouble("multiHeadDrawForcedReplyAuxPolicyGate",        0.0, 1.0);
    else                                                               params.multiHeadDrawForcedReplyAuxPolicyGate = 0.0;
    if(cfg.contains("multiHeadDrawForcedReplySidecarVisits"+idxStr)) params.multiHeadDrawForcedReplySidecarVisits = cfg.getDouble("multiHeadDrawForcedReplySidecarVisits"+idxStr, 0.0, 64.0);
    else if(cfg.contains("multiHeadDrawForcedReplySidecarVisits"))   params.multiHeadDrawForcedReplySidecarVisits = cfg.getDouble("multiHeadDrawForcedReplySidecarVisits",        0.0, 64.0);
    else                                                                params.multiHeadDrawForcedReplySidecarVisits = 0.0;
    if(cfg.contains("multiHeadDrawForcedReplySidecarMaxProp"+idxStr)) params.multiHeadDrawForcedReplySidecarMaxProp = cfg.getDouble("multiHeadDrawForcedReplySidecarMaxProp"+idxStr, 0.0, 0.9);
    else if(cfg.contains("multiHeadDrawForcedReplySidecarMaxProp"))   params.multiHeadDrawForcedReplySidecarMaxProp = cfg.getDouble("multiHeadDrawForcedReplySidecarMaxProp",        0.0, 0.9);
    else                                                                 params.multiHeadDrawForcedReplySidecarMaxProp = 0.0;
    if(cfg.contains("multiHeadDrawForcedReplyPolicyThreshold"+idxStr)) params.multiHeadDrawForcedReplyPolicyThreshold = cfg.getDouble("multiHeadDrawForcedReplyPolicyThreshold"+idxStr, 0.0, 0.99);
    else if(cfg.contains("multiHeadDrawForcedReplyPolicyThreshold"))   params.multiHeadDrawForcedReplyPolicyThreshold = cfg.getDouble("multiHeadDrawForcedReplyPolicyThreshold",        0.0, 0.99);
    else                                                                params.multiHeadDrawForcedReplyPolicyThreshold = 0.5;
    if(cfg.contains("multiHeadVctGuidedPlayoutProp"+idxStr)) params.multiHeadVctGuidedPlayoutProp = cfg.getDouble("multiHeadVctGuidedPlayoutProp"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadVctGuidedPlayoutProp"))   params.multiHeadVctGuidedPlayoutProp = cfg.getDouble("multiHeadVctGuidedPlayoutProp",        0.0, 1.0);
    else                                                      params.multiHeadVctGuidedPlayoutProp = 0.0;
    if(cfg.contains("multiHeadDrawGuidedPlayoutProp"+idxStr)) params.multiHeadDrawGuidedPlayoutProp = cfg.getDouble("multiHeadDrawGuidedPlayoutProp"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadDrawGuidedPlayoutProp"))   params.multiHeadDrawGuidedPlayoutProp = cfg.getDouble("multiHeadDrawGuidedPlayoutProp",        0.0, 1.0);
    else                                                       params.multiHeadDrawGuidedPlayoutProp = 0.0;
    if(cfg.contains("multiHeadGuidedStartFraction"+idxStr)) params.multiHeadGuidedStartFraction = cfg.getDouble("multiHeadGuidedStartFraction"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadGuidedStartFraction"))   params.multiHeadGuidedStartFraction = cfg.getDouble("multiHeadGuidedStartFraction",        0.0, 1.0);
    else                                                     params.multiHeadGuidedStartFraction = 0.0;
    if(cfg.contains("multiHeadGuidedPolicyMix"+idxStr)) params.multiHeadGuidedPolicyMix = cfg.getDouble("multiHeadGuidedPolicyMix"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadGuidedPolicyMix"))   params.multiHeadGuidedPolicyMix = cfg.getDouble("multiHeadGuidedPolicyMix",        0.0, 1.0);
    else                                                 params.multiHeadGuidedPolicyMix = 1.0;
    if(cfg.contains("multiHeadGuidedValueWeight"+idxStr)) params.multiHeadGuidedValueWeight = cfg.getDouble("multiHeadGuidedValueWeight"+idxStr, 0.0, 2.0);
    else if(cfg.contains("multiHeadGuidedValueWeight"))   params.multiHeadGuidedValueWeight = cfg.getDouble("multiHeadGuidedValueWeight",        0.0, 2.0);
    else                                                   params.multiHeadGuidedValueWeight = 0.0;
    if(cfg.contains("multiHeadOutcomeIntervalExplore"+idxStr)) params.multiHeadOutcomeIntervalExplore = cfg.getDouble("multiHeadOutcomeIntervalExplore"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadOutcomeIntervalExplore"))   params.multiHeadOutcomeIntervalExplore = cfg.getDouble("multiHeadOutcomeIntervalExplore",        0.0, 10.0);
    else                                                        params.multiHeadOutcomeIntervalExplore = 0.0;
    if(cfg.contains("multiHeadOutcomeIntervalVisitScale"+idxStr)) params.multiHeadOutcomeIntervalVisitScale = cfg.getDouble("multiHeadOutcomeIntervalVisitScale"+idxStr, 0.1, 10000.0);
    else if(cfg.contains("multiHeadOutcomeIntervalVisitScale"))   params.multiHeadOutcomeIntervalVisitScale = cfg.getDouble("multiHeadOutcomeIntervalVisitScale",        0.1, 10000.0);
    else                                                           params.multiHeadOutcomeIntervalVisitScale = 8.0;
    if(cfg.contains("multiHeadAuxPolicyChildGate"+idxStr)) params.multiHeadAuxPolicyChildGate = cfg.getDouble("multiHeadAuxPolicyChildGate"+idxStr, 0.0, 1.0);
    else if(cfg.contains("multiHeadAuxPolicyChildGate"))   params.multiHeadAuxPolicyChildGate = cfg.getDouble("multiHeadAuxPolicyChildGate",        0.0, 1.0);
    else                                                    params.multiHeadAuxPolicyChildGate = 0.0;
    if(cfg.contains("multiHeadAuxPolicyVisitScale"+idxStr)) params.multiHeadAuxPolicyVisitScale = cfg.getDouble("multiHeadAuxPolicyVisitScale"+idxStr, 0.0, 10000.0);
    else if(cfg.contains("multiHeadAuxPolicyVisitScale"))   params.multiHeadAuxPolicyVisitScale = cfg.getDouble("multiHeadAuxPolicyVisitScale",        0.0, 10000.0);
    else                                                     params.multiHeadAuxPolicyVisitScale = 0.0;
    if(cfg.contains("multiHeadAuxPolicyOptimism"+idxStr)) params.multiHeadAuxPolicyOptimism = cfg.getDouble("multiHeadAuxPolicyOptimism"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadAuxPolicyOptimism"))   params.multiHeadAuxPolicyOptimism = cfg.getDouble("multiHeadAuxPolicyOptimism",        0.0, 10.0);
    else                                                   params.multiHeadAuxPolicyOptimism = 0.0;
    if(cfg.contains("multiHeadAuxPolicyConcentrationScale"+idxStr)) params.multiHeadAuxPolicyConcentrationScale = cfg.getDouble("multiHeadAuxPolicyConcentrationScale"+idxStr, 0.001, 1.0);
    else if(cfg.contains("multiHeadAuxPolicyConcentrationScale"))   params.multiHeadAuxPolicyConcentrationScale = cfg.getDouble("multiHeadAuxPolicyConcentrationScale",        0.001, 1.0);
    else                                                              params.multiHeadAuxPolicyConcentrationScale = 0.10;
    if(cfg.contains("multiHeadAuxValueExplore"+idxStr)) params.multiHeadAuxValueExplore = cfg.getDouble("multiHeadAuxValueExplore"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadAuxValueExplore"))   params.multiHeadAuxValueExplore = cfg.getDouble("multiHeadAuxValueExplore",        0.0, 10.0);
    else                                                 params.multiHeadAuxValueExplore = 0.0;
    if(cfg.contains("multiHeadAuxValueVisitScale"+idxStr)) params.multiHeadAuxValueVisitScale = cfg.getDouble("multiHeadAuxValueVisitScale"+idxStr, 0.1, 10000.0);
    else if(cfg.contains("multiHeadAuxValueVisitScale"))   params.multiHeadAuxValueVisitScale = cfg.getDouble("multiHeadAuxValueVisitScale",        0.1, 10000.0);
    else                                                    params.multiHeadAuxValueVisitScale = 8.0;
    if(cfg.contains("multiHeadVctCpuctScale"+idxStr)) params.multiHeadVctCpuctScale = cfg.getDouble("multiHeadVctCpuctScale"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctCpuctScale"))   params.multiHeadVctCpuctScale = cfg.getDouble("multiHeadVctCpuctScale",        0.0, 10.0);
    else                                              params.multiHeadVctCpuctScale = 1.0;
    if(cfg.contains("multiHeadVctValueWeightExponent"+idxStr)) params.multiHeadVctValueWeightExponent = cfg.getDouble("multiHeadVctValueWeightExponent"+idxStr, 0.0, 2.0);
    else if(cfg.contains("multiHeadVctValueWeightExponent"))   params.multiHeadVctValueWeightExponent = cfg.getDouble("multiHeadVctValueWeightExponent",        0.0, 2.0);
    else                                                        params.multiHeadVctValueWeightExponent = 0.5;
    if(cfg.contains("multiHeadVctValidationProp"+idxStr)) params.multiHeadVctValidationProp = cfg.getDouble("multiHeadVctValidationProp"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctValidationProp"))   params.multiHeadVctValidationProp = cfg.getDouble("multiHeadVctValidationProp",        0.0, 10.0);
    else                                                  params.multiHeadVctValidationProp = 0.25;
    if(cfg.contains("multiHeadVctValidationUtility"+idxStr)) params.multiHeadVctValidationUtility = cfg.getDouble("multiHeadVctValidationUtility"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctValidationUtility"))   params.multiHeadVctValidationUtility = cfg.getDouble("multiHeadVctValidationUtility",        0.0, 10.0);
    else                                                     params.multiHeadVctValidationUtility = 2.0;
    if(cfg.contains("multiHeadVctValidationOptimism"+idxStr)) params.multiHeadVctValidationOptimism = cfg.getDouble("multiHeadVctValidationOptimism"+idxStr, -10.0, 10.0);
    else if(cfg.contains("multiHeadVctValidationOptimism"))   params.multiHeadVctValidationOptimism = cfg.getDouble("multiHeadVctValidationOptimism",        -10.0, 10.0);
    else                                                       params.multiHeadVctValidationOptimism = -1.0;
    if(cfg.contains("multiHeadVctNormalVerificationProp"+idxStr)) params.multiHeadVctNormalVerificationProp = cfg.getDouble("multiHeadVctNormalVerificationProp"+idxStr, 0.0, 0.9);
    else if(cfg.contains("multiHeadVctNormalVerificationProp"))   params.multiHeadVctNormalVerificationProp = cfg.getDouble("multiHeadVctNormalVerificationProp",        0.0, 0.9);
    else                                                           params.multiHeadVctNormalVerificationProp = 0.0;
    if(cfg.contains("multiHeadVctMoveSelectionWeight"+idxStr)) params.multiHeadVctMoveSelectionWeight = cfg.getDouble("multiHeadVctMoveSelectionWeight"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctMoveSelectionWeight"))   params.multiHeadVctMoveSelectionWeight = cfg.getDouble("multiHeadVctMoveSelectionWeight",        0.0, 10.0);
    else                                                        params.multiHeadVctMoveSelectionWeight = 0.0;
    if(cfg.contains("multiHeadVctRelativeMoveSelectionWeight"+idxStr)) params.multiHeadVctRelativeMoveSelectionWeight = cfg.getDouble("multiHeadVctRelativeMoveSelectionWeight"+idxStr, 0.0, 20.0);
    else if(cfg.contains("multiHeadVctRelativeMoveSelectionWeight"))   params.multiHeadVctRelativeMoveSelectionWeight = cfg.getDouble("multiHeadVctRelativeMoveSelectionWeight",        0.0, 20.0);
    else                                                                params.multiHeadVctRelativeMoveSelectionWeight = 0.0;
    if(cfg.contains("multiHeadVctNnMoveSelectionWeight"+idxStr)) params.multiHeadVctNnMoveSelectionWeight = cfg.getDouble("multiHeadVctNnMoveSelectionWeight"+idxStr, 0.0, 10.0);
    else if(cfg.contains("multiHeadVctNnMoveSelectionWeight"))   params.multiHeadVctNnMoveSelectionWeight = cfg.getDouble("multiHeadVctNnMoveSelectionWeight",        0.0, 10.0);
    else                                                          params.multiHeadVctNnMoveSelectionWeight = 0.0;
    if(cfg.contains("multiHeadVctMoveSelectionVisitScale"+idxStr)) params.multiHeadVctMoveSelectionVisitScale = cfg.getDouble("multiHeadVctMoveSelectionVisitScale"+idxStr, 0.1, 10000.0);
    else if(cfg.contains("multiHeadVctMoveSelectionVisitScale"))   params.multiHeadVctMoveSelectionVisitScale = cfg.getDouble("multiHeadVctMoveSelectionVisitScale",        0.1, 10000.0);
    else                                                           params.multiHeadVctMoveSelectionVisitScale = 8.0;
