...
struct SearchParams {
  ...
  double noResultUtilityReduceEarly;   // Decrease draw utility for both side (if positive)
  double noResultUtilityReduceNearDraw;   // Decrease draw utility for both side (if positive)
